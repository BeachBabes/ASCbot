...
client.on('message', async msg => {
    ...
    if(command === 'help')
    {
        ...
        .addField('.lockdown', 'Initiates a server lockdown, muting all channels. (You must have a role called lockdown for this to work)')
        .addField('.unlock', 'Ends the servers lockdown')
	...
	msg.channel.send(help)
        ...
        .addField('.rules', 'Sends the servers rules')
        .addField('.animerole', 'Gives you the Anime Connoisseur role')
        .addField('.eventrole', 'Gives you the Events role')
        .addField('.malerole', 'Gives you the Male role')
        .addField('.femalerole', 'Gives you the Female role')
        .addField('.mafiarole', 'Gives you the Mafia role')
        .addField('.red', 'Gives you the Red role')
        .addField('.blue', 'Gives you the Blue role')
        .addField('.green', 'Gives you the Green role')
        .addField('.orange', 'Gives you the Orange role')
        .addField('.purple', 'Gives you the Purple role')
        .addField('.yellow', 'Gives you the Yellow role')
        .addField('.rps (rock, paper, or scissors)', 'Plays rock paper scissors with you')
        .addField('.roll', 'Rolls a 6 sided die')
        .addField('.copypasta', 'Sends a random Copypasta')
        .addField('.pp', 'Tells you how large your pp is')
        .addField('.create', 'Creates a new poll for the server to vote on')
        .addField('.time', 'Tells you your local time')
...
if(command === 'adminskips')
{
    ...
    {
        let roleUser = msg.author
        let role = msg.member.guild.roles.find(role => role.name === 'Golden Wind')
        var perms2 = new discord.RichEmbed()
        .addField('Role added!',`You have been given the ${role} role!`)
        msg.guild.member(roleUser).addRole(role)
        msg.channel.send(perms2)
    ...
    {
        let roleUser = msg.author
        let role = msg.member.guild.roles.find(role => role.name === 'Bright Fucking Blue')
        var perms2 = new discord.RichEmbed()
        .addField('Role added!',`You have been given the ${role} role!`)
        msg.guild.member(roleUser).addRole(role)
        msg.channel.send(perms2)
    ...
    {
        let roleUser = msg.author
        let role = msg.member.guild.roles.find(role => role.name === 'Pink Panther')
        var perms2 = new discord.RichEmbed()
        .addField('Role added!',`You have been given the ${role} role!`)
        msg.guild.member(roleUser).addRole(role)
        msg.channel.send(perms2)
    ...
    {
        let roleUser = msg.author
        let role = msg.member.guild.roles.find(role => role.name === 'Nicotine Mint')
        var perms2 = new discord.RichEmbed()
        .addField('Role added!',`You have been given the ${role} role!`)
        msg.guild.member(roleUser).addRole(role)
        msg.channel.send(perms2)
    ...
    {
        let roleUser = msg.author
        let role = msg.member.guild.roles.find(role => role.name === 'Just Black')
        var perms2 = new discord.RichEmbed()
        .addField('Role added!',`You have been given the ${role} role!`)
        msg.guild.member(roleUser).addRole(role)
        msg.channel.send(perms2)
    ...
    {
        let roleUser = msg.author
        let role = msg.member.guild.roles.find(role => role.name === 'Cum Stain White')
        var perms2 = new discord.RichEmbed()
        .addField('Role added!',`You have been given the ${role} role!`)
        msg.guild.member(roleUser).addRole(role)
        msg.channel.send(perms2)
    ...
    {
        let roleUser = msg.author
        let role = msg.member.guild.roles.find(role => role.name === 'Blood Red')
        var perms2 = new discord.RichEmbed()
        .addField('Role added!',`You have been given the ${role} role!`)
        msg.guild.member(roleUser).addRole(role)
        msg.channel.send(perms2)
    ...
    {
        let roleUser = msg.author
        let role = msg.member.guild.roles.find(role => role.name === 'Blue Balls')
        var perms2 = new discord.RichEmbed()
        .addField('Role added!',`You have been given the ${role} role!`)
        msg.guild.member(roleUser).addRole(role)
        msg.channel.send(perms2)
    ...
    {
        let roleUser = msg.author
        let role = msg.member.guild.roles.find(role => role.name === 'Baby Shit Green')
        var perms2 = new discord.RichEmbed()
        .addField('Role added!',`You have been given the ${role} role!`)
        msg.guild.member(roleUser).addRole(role)
        msg.channel.send(perms2)
    ...
    {
        let roleUser = msg.author
        let role = msg.member.guild.roles.find(role => role.name === 'Prison Orange')
        var perms2 = new discord.RichEmbed()
        .addField('Role added!',`You have been given the ${role} role!`)
        msg.guild.member(roleUser).addRole(role)
        msg.channel.send(perms2)
    ...
    {
        let roleUser = msg.author
        let role = msg.member.guild.roles.find(role => role.name === 'Purple Rain')
        var perms2 = new discord.RichEmbed()
        .addField('Role added!',`You have been given the ${role} role!`)
        msg.guild.member(roleUser).addRole(role)
        msg.channel.send(perms2)
...
if(command === 'fn')
    ...
    {
        let roleUser = msg.author
        let role = msg.member.guild.roles.find(role => role.name === 'Shit-Post')
        var perms2 = new discord.RichEmbed()
        .addField('Role added!',`You have been given the ${role} role!`)
        msg.guild.member(roleUser).addRole(role)
        msg.channel.send(perms2)
